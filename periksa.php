    ...
    <div class="container">
        ...
        <form class="form col" method="POST" action="" name="myForm" onsubmit="return(validate());">
            ...
            <div class="form-group mx-sm-3 mb-2">
                ...
                <textarea type="text" class="form-control" name="catatan" id="catatan" placeholder="catatan"><?= $catatan ?></textarea>
            </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success rounded-pill px-3" href="index2.php?page=periksa&id=<?php echo $data['id'] ?>">
                                Ubah</a>
                            <a class="btn btn-danger rounded-pill px-3" href="index2.php?page=periksa&id=<?php echo $data['id'] ?>&aksi=hapus">
                                Hapus</a>
                        </td>
                    </tr>
                <?php
        ...
        if (isset($_POST['simpan'])) {
            ...
            echo "<script> 
                            document.location='index2.php?page=periksa';
                            </script>";
        }
